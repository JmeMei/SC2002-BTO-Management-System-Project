...
public class ProjectAvailableView {
    ...
    public void fullDisplay(List<Room> rooms){
        ...
        System.out.printf("%-20s %-20s %-20s %-20s %-20s %-20s %-20s\n",
                "Project ID","Project Name", "Neighborhood", "Price", "Opening Date", "Closing Date", "Available");
        ...
        for(Room room : rooms) {
            System.out.printf("%-20s %-20s %-20s %-20s %-20s %-20s %-20s\n",
                    room.getProjectID(),room.getProjectName(), room.getNeighborhood(), room.getPriceType1(), room.getOpeningDate(), room.getClosingDate(), room.getNumUnitsType());
        }
    }
}
